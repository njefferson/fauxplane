...
/social-preview-icon.jpg — because saving a file out of the GitHub UI on an
iPad turned out to be the hard part of the whole feature. Two designs: the
concept-render card and an icon-art card drawn entirely from the app's own
artwork.
